...
APP_PATH=${WORK_DIR}/aop/src/main/webapp
BUILD_PATH=${WORK_DIR}/aop/build
RELEASE_WAR=aop-1.0.0-SNAPSHOT.war
RELEASE_PATH=${BUILD_PATH}/libs/${RELEASE_WAR}
PUBLISH_DIR=/mnt/mercury_mimas_hotfix
...
echo $APP_VER.hotfix > ${APP_PATH}/version.txt
...
echo ${APP_VER}.hotfix > ${PUBLISH_LATEST_DIR}/version.txt
